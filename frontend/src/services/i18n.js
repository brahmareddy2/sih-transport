...
export const DICTIONARY = {
  ...
  login_portal_sub: {
    en: 'Your Intelligent Logistics Co-Pilot',
    te: 'మీ ఇంటెలిజెంట్ లాజిస్టిక్స్ కో-పైలట్',
    hi: 'आपका इंटेलिजेंट लॉजिस्टिक्स को-पायलट',
    pa: 'ਤੁਹਾਡਾ ਇੰਟੈਲੀਜੈਂਟ ਲੌਜਿਸਟਿਕਸ ਕੋ-ਪਾਇਲਟ',
    mr: 'तुमचा इंटेलिजेंट लॉजिस्टिक्स को-पायलट',
  },
  single_click_login: {
